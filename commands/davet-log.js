  ...
  run: async (client, message, args, db) => {
    ...
    if (getActive === "ayarla") {
      ...
      return message.reply({
        embeds: [
          reply(
            `${emote.success} **|** Davet log kanalı başarıyla ${mentionChannel} olarak ayarlandı.`,
            message
          ),
        ],
      });
      ...
      return message.reply({
        embeds: [
          reply(
            `${emote.success} **|** Davet log sistemi \`de-aktif\` edildi.`,
            message
          ),
        ],
      });
      ...
      return message.reply({
        embeds: [
          reply(
            `${emote.danger} **|** Komutu yanlış belirttin, \`${config.prefix}davet-log <ayarla/sıfırla>\` `,
            message
          ),
        ],
      });
